...
/**
	...
	public class GeneratorUtils {
		...
		private function _writeValueToGenerator(slotValue:Object, generator:ProjectData, slotType:String):void {
			// TODO: implement for version 1.0 Beta
		}
		 ...
		 */
		private function _onAvailableGeneratorsRequested(...etc):void {
		 ...
		 */
		private function _onGenCfgForceCloseRequested(...etc):void {
		 ...
		 */
		private function _onGenCfgWindowClosed(...etc):void {
		...
		private function _onGenCfgRequested(generatorInstance:GeneratorInstance):void {
			...
			var show_configuration_for:Function = function (generator_instance:GeneratorInstance):void {
				...
				_controller.windowsManager.updateWindowMinSize(_controller.genCfgWindowUid, Sizes.MIN_GEN_CFG_WINDOW_BOUNDS.width, Sizes.MIN_GEN_CFG_WINDOW_BOUNDS.height, true);
				_controller.windowsManager.observeWindowActivity(_controller.genCfgWindowUid, WindowActivity.BEFORE_DESTROY, _onGenCfgWindowClosing, this);
				_controller.windowsManager.showWindow(_controller.genCfgWindowUid);
				_controller.windowsManager.alignWindows(_controller.genCfgWindowUid, _controller.windowsManager.mainWindow, 0.5, 0.5);
		 ...
		 */
		private static function _onGenCfgWindowClosing(...etc):Boolean {
